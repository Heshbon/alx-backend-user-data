#!/usr/bin/env python3
""" The module for filtering logs and redacting sensitive information."""
...
def get_logger() -> logging.Logger:
    """ Creates and config a logger for user data
...
class RedactingFormatter(logging.Formatter):
    ...
    def __init__(self, fields: List[str]):
        """  Initializes the RedactingFormatter with fields to redact
    ...
    def format(self, record: logging.LogRecord) -> str:
        """ Formats a LogRecord, redacting specified field
